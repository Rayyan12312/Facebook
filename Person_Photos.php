                 ...
                 <div class="panel panel-default">
                   ...
                   <div class="panel-body">
                       ...
                       <?php while($row=mysqli_fetch_array($pics)) {?>
                         ...
                         <img class="img-tag" style="margin:0px; border: solid;margin-right:5px; margin-bottom:5px;" src="<?php echo $row['Picture']; ?>" alt="" height="200" width="200" >
                       <?php } ?>
