...
<?php
$q="SELECT * FROM post WHERE UserID='$uid'";
                ...
                <div class="panel panel-default">
                  ...
                  <div class="panel-body">
                    ...
                    <div class="input-group">
                      <div class="input-group-btn">
                        <a href="InsertLikeFromFriend.php?id=<?php echo $row['PostID']; ?> && pid=<?php echo $uid; ?>">
                      <button class="btn btn-default">Like</button>
                      </a>
                      </div>
                      <form style="margin-top:14px;" class="" action="InsertCommentFromFriend.php?id=<?php echo $row['PostID']; ?> && pid=<?php echo $uid; ?>" method="post">
